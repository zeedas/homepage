    ...
    <footer>
      <div className="footer-grid">
        ...
        <div className="div2">
          ...
          <ol className="">
            <li className="text-gray underline-none">
      ...
      <p className="footer-text">
        ...
        <br /> © 2020 Zeedas, Ltd. All rights reserved All text, graphics, audio
        files, code, downloadable material, and other works on this web site are
        the copyrighted works of Zeedas, Inc. All Rights Reserved. Any
        unauthorized redistribution or reproduction of any copyrighted materials
        on this web site is strictly prohibited. Other product and company names
        are trademarks of their respective owners. This web site contains
